...
with torch.no_grad():
    for input, gt in test_loader:
        ...
        plot.imsave('./testimg/Test_input_rgb_{:05d}.png'.format(idx), input_rgb_image)
        plot.imsave('./testimg/Test_gt_depth_{:05d}.png'.format(idx), input_gt_depth_image, cmap="viridis")
        plot.imsave('./testimg/Test_pred_depth_{:05d}.png'.format(idx), pred_depth_image, cmap="viridis")
